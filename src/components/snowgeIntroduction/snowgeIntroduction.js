  ...
  //   }, [])
    ...
    return (
        <div className={'flex-column y-centre x-centre snowge-introduction-container'}>
            ...
            <div className={'snowge-contract-addy'}><b>0x5e9280d53f28281ce098c8f64e49f5f5dc9ea185</b></div>
            <div className={'snowge-buttons-div flex-row wrap x-centre space-between'}>
            ...
            <div className={'numbers-div flex-row x-centre space-between wrap'}>
